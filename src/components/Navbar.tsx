    ...
    >
      <div className="section-container flex items-center justify-between">
        ...
        <a
          ...
          className="font-bold text-xl tracking-tight text-[#0B0F17] hover:text-slate-700 transition-colors"
        >
          Nitish Naik
        </a>
        ...
        {/* Black Pill Contact Button matching screenshot */}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 px-4 pt-3 pb-6 space-y-3 shadow-lg">
          <button
            onClick={() => scrollToSection("about")}
            className="w-full text-left px-3 py-2 text-slate-700 font-medium"
          >
            About
          </button>
          <button
